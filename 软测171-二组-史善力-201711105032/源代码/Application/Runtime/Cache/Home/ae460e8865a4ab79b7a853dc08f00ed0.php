  ...
  <body >
    <div style="width: " >
      ...
      <div id="u70" class="ax_default icon">
        <!-- <img id="u70_img" class="img " src="images/通讯录管理/u70.png"/> -->
      </div>
      ...
      <div id="u72" class="ax_default icon">
        <!-- <img id="u72_img" class="img " src="images/通讯录管理/u72.png"/> -->
      </div>
    ...
    <div id="base" class="" style="margin-top: 50px;">
      ...
      <form action="<?php echo U('Index/changeaddinfo');?>" method="post" >

        <div   id="dvLoginBox"> 
            <?php if(is_array($row)): $i = 0; $__LIST__ = $row;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="text-align: center;" >
         <span class="tanchuang2">修改信息</span><hr>
        <input style="display: none;" class="xiugaixixin" type="text" name="myid" value="<?php echo ($vo["id"]); ?>"><br>
         <label>姓名：</label><input class="xiugaixixin" type="text" name="name" value="<?php echo ($vo["sname"]); ?>"><br>
         <label>手机：</label><input class="xiugaixixin" type="text" name="tel" value="<?php echo ($vo["tel"]); ?>"><br>
         <label>性别：</label><input class="xiugaixixin" type="text" name="sex" value="<?php echo ($vo["sex"]); ?>"><br>
         <label>邮箱：</label><input class="xiugaixixin" type="text" name="email" value="<?php echo ($vo["email"]); ?>"><br>
         <label>单位：</label><input class="xiugaixixin" type="text" name="position" value="<?php echo ($vo["sname"]); ?>"><br>
         <label>生日：</label><input class="xiugaixixin" type="text" name="birthday" value="<?php echo ($vo["work"]); ?>"><br>
         <label>q&nbsp; q：</label><input class="xiugaixixin" type="text" name="qq" value="<?php echo ($vo["qq"]); ?>"><br>
         <label>住址：</label><input class="xiugaixixin" type="text" name="address" value="<?php echo ($vo["address"]); ?>"><br>
         <label>爱好：</label><input class="xiugaixixin" type="text" name="hobby" value="<?php echo ($vo["hobby"]); ?>"><br>
         </div>

           <input style="text-align: center;" class="apply-btn"  type="submit" name="addpeopleinfo" value="提交"><?php endforeach; endif; else: echo "" ;endif; ?>
          </div>
         </form>
